...
Purpose:
	This source implements LibManager, responsible for initializing, closing, 
	installing, uninstalling the dependent libs(.dll) of the application.
...
//			AB_ASSERT(padLen > 0 && padLen <= 16);
		...
		case CBC:
			...
			padLen = 16 - (inputOctets - 16*numBlocks);
//			AB_ASSERT(padLen > 0 && padLen <= 16); // DO SOMETHING HERE ?

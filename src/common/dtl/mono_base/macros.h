...
#define IO_LAYER_LOWORD(i32) ((guint16)((i32) & 0xFFFF))
#define IO_LAYER_HIWORD(i32) ((guint16)(((guint32)(i32) >> 16) & 0xFFFF))
#define IO_LAYER_LOBYTE(i16) ((guint8)((i16) & 0xFF))
#define IO_LAYER_HIBYTE(i16) ((guint8)(((guint16)(i16) >> 8) & 0xFF))

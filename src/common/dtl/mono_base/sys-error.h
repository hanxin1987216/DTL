...
#ifndef _WAPI_SYS_ERROR_H_
#define _WAPI_SYS_ERROR_H_

#define	ERROR_SUCCESS 					0
#define 	ERROR_ALREADY_EXISTS			EEXIST
#define 	ERROR_FILE_NOT_FOUND			ENOENT
#define 	ERROR_NO_MORE_FILES				ENFILE
...
#define 	ERROR_SHARING_VIOLATION		EAGAIN
#define 	ERROR_LOCK_VIOLATION			EBUSY
...
//
// @hx: On Linux Platform, use errno as the error value because class SystemErrorHandler 
// call strerror to show error string.
//
#if 0
guint32 errno_to_WSA (guint32 code, const char *function_name);
gint _wapi_get_win32_file_error (gint err);
#else
#define errno_to_WSA(code, function_name) code
#define _wapi_get_win32_file_error(err) err
#endif

G_END_DECLS

#endif /* _WAPI_SYS_ERROR_H_ */

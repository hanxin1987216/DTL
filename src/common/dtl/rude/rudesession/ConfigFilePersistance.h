...
#ifndef INCLUDED_ConfigFilePersistance_H
#define INCLUDED_ConfigFilePersistance_H
...
class ConfigFilePersistance: public AbstractPersistance{

public:
	ConfigFilePersistance(){};
	~ConfigFilePersistance(){};
